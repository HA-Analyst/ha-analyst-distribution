...
## 1.0.17.85 – B0.1.02 – Diagnostics & External Validation
...
- Das veröffentlichte Manifest `ghcr.io/ha-analyst/ha-analyst:1.0.17.85` ist anonym lesbar; beide unterstützten Architekturen lassen sich ohne Registry-Credentials ziehen.
...
- The published manifest `ghcr.io/ha-analyst/ha-analyst:1.0.17.85` is anonymously readable and both supported architectures can be pulled without registry credentials.
